  ...
  return (
    <div className='h-screen overflow-hidden pt-32 md:pt-32'>
      <div className='space-y-10 md:space-y-20 flex flex-col items-center'>
        <h1 className='font-semibold text-2xl md:text-5xl text-white md:leading-relaxed'>Hi there! The name&apos;s Stephen. I&apos;m a <span className='text-orange-500'>product & strategy program manager</span> at ServiceNow looking to build delightful experiences and products for <s>users</s> humans.</h1>
        <Link href='#about'>
