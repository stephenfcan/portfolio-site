...
const About = () => {
  return (
    <div className='min-h-screen h-full pt-32 py-40'>
      <div className='flex flex-col items-start space-y-5 md:flex-row md:space-x-5 md:space-y-0'>
        ...
        <div className=''>
          <p className='text-white md:text-lg font-light mb-3'>A Georgia native now in Silicon Valley, I consider myself a life-long learner and risk-taker - a constant cycle of failing fast and individual growth. I thrive in uncertainty, exploring new ideas, designing a cohesive vision, and executing relentlessly.</p>
